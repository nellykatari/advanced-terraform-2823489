...
# S3 BUCKET
# //////////////////////////////
resource "aws_s3_bucket" "red30nel2-tfremotestate" {
...
resource "aws_s3_bucket_public_access_block" "red30nel2-tfremotestate" {
  bucket = aws_s3_bucket.red30nel2-tfremotestate.id
